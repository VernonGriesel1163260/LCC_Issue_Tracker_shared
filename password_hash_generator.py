...
users = [UserAccount('sthompson', 'sthompson'),
         UserAccount('jwilson', 'jwilson'),
         UserAccount('mchen', 'mchen'),
         UserAccount('doconnor', 'doconnor'),
         UserAccount('aparker', 'aparker'),
         UserAccount('rpatel', 'rpatel'),
         UserAccount('efoster', 'efoster'),
         UserAccount('mwilliams', 'mwilliams'),
         UserAccount('lsmith', 'lsmith'),
         UserAccount('btaylor', 'btaylor'),
         UserAccount('alee', 'alee'),
         UserAccount('jbrown', 'jbrown'),
         UserAccount('kwood', 'kwood'),
         UserAccount('dharris', 'dharris'),
         UserAccount('sclark', 'sclark'),
         UserAccount('pnguyen', 'pnguyen'),
         UserAccount('ywood', 'ywood'),
         UserAccount('gking', 'gking'),
         UserAccount('ewhite', 'ewhite'),
         UserAccount('rjones', 'rjones'),
         UserAccount('janderson', 'janderson'),
         UserAccount('mrodriguez', 'mrodriguez'),
         UserAccount('tmitchell', 'tmitchell'),
         UserAccount('hstewart', 'hstewart'),
         UserAccount('wturner', 'wturner'),
         UserAccount('mcollins', 'mcollins'),
         UserAccount('rclarke', 'rclarke')]
